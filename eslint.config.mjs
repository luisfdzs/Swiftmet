...
// regla sólo se puede declarar en el mismo objeto que registra su plugin, y el plugin
// lo aporta `eslint-config-next`. Las reglas de `next/core-web-vitals` son suficientes.
